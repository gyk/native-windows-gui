...
impl GlobalCursor {
    ...
    */
    pub fn local_position<C: Into<ControlHandle>>(
        ...
        const MSG: &str = "local_position can only be used for window control";
    ...
    */
    pub fn set_capture(control: &ControlHandle) {
        ...
        const MSG: &str = "Mouse capture can only be set for window control";
    ...
    */
    pub fn dragging(control: &ControlHandle, point: Option<(i32, i32)>) -> bool {
        ...
        const MSG: &str = "Dragging can only be set for window control";
