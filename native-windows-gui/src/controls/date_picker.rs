...
const NOT_BOUND: &str = "DatePicker is not yet bound to a winapi object";
const BAD_HANDLE: &str = "INTERNAL ERROR: DatePicker handle is not HWND!";
...
impl DatePicker {
    ...
    */
    pub fn value(&self) -> Option<DatePickerValue> {
        ...
        let r =
            unsafe { wh::send_message(handle, DTM_GETSYSTEMTIME, 0, mem::transmute(&mut syst)) };
        match r {
