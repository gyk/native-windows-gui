...
const NOT_BOUND: &str = "ListBox is not yet bound to a winapi object";
const BAD_HANDLE: &str = "INTERNAL ERROR: ListBox handle is not HWND!";
    ...
    pub fn selection_string(&self) -> Option<String> {
        ...
        if index == LB_ERR {
            ...
            unsafe {
                ...
                wh::send_message(handle, LB_GETTEXT, index, buffer.as_ptr() as isize);
            }
