...
const NOT_BOUND: &str = "Notice is not yet bound to a winapi object";
const UNUSABLE_NOTICE: &str = "Notice parent window was freed";
const BAD_HANDLE: &str = "INTERNAL ERROR: Notice handle is not Notice!";
