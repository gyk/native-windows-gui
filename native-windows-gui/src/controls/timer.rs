...
const NOT_BOUND: &str = "Timer is not yet bound to a winapi object";
const UNUSABLE_TIMER: &str = "Timer parent window was freed";
const BAD_HANDLE: &str = "INTERNAL ERROR: Timer handle is not Timer!";
